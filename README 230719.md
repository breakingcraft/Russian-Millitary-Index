...
- Space Forces
  - Russian space tracking
	...
	NIP / Separate Command and Measurement Complex / Soviet Deep Space Network _Many were earlier unidentified installations and bases_
  ...
  - 15th Special Purpose Aerospace Army
    - 820th Main Centre for Missile Attack Warning (GTsPRN)
      _Sorted: Over The Horizont Radar Sites in folders per type as that is easier to find in the placemark list_
      	US-KS "Oko" (Early Warning Satellites) Control Sites

    - 821st Main Space Intelligence Centre  (GTsRKO)
      _Sored and add some small things_
